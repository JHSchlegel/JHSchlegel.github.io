...
The full code for this analysis is available on [<i class="bi bi-github"></i> GitHub](https://github.com/JHSchlegel/soccer-analytics). Note that the underlying data is confidential and therefore not included in the repository.
...
<img src="results/plots/offside_count_by_player.png" width="100%">
...
<video width="100%" controls>
  <source src="results/offsides/Spain - Scotland - 10-12-2023/2257919/Spain_Scotland_22570_to_22609_animation.mp4" type="video/mp4">
</video>
<em>Cross from Dani Carvajal to Álvaro Morata (Spain vs Scotland)</em>
</td>
<td style="width:50%; padding:4px;">
<video width="100%" controls>
  <source src="results/offsides/Spain - Georgia - 11-19-2023/1353053/Spain_Georgia_13521_to_13560_animation.mp4" type="video/mp4">
</video>
...
<td style="width:50%; padding:4px;">
<video width="100%" controls>
  <source src="results/offsides/Spain - Scotland - 10-12-2023/391259/Spain_Scotland_33433_to_33472_animation.mp4" type="video/mp4">
</video>
<em>Through ball from Pedro Porro to Álvaro Morata (Spain vs Scotland)</em>
</td>
<td style="width:50%; padding:4px;">
<video width="100%" controls>
  <source src="results/offsides/Spain - Scotland - 10-12-2023/1793219/Spain_Scotland_17923_to_17962_animation.mp4" type="video/mp4">
</video>
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/pass_accuracy.png" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/pass_accuracy_pressure.png" width="100%">
</td>
</tr>
</table>
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/sonar_plots/Cyprus_Spain_1_3_pass_sonar.png" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/sonar_plots/Norway_Spain_0_1_pass_sonar.png" width="100%">
</td>
</tr>
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/sonar_plots/Spain_Georgia_3_1_pass_sonar.png" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/sonar_plots/Spain_Scotland_2_0_pass_sonar.png" width="100%">
</td>
</tr>
</table>
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/throw_in_sonar.png" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/throw_in_accuracy.png" width="100%">
</td>
</tr>
</table>
...
<img src="results/plots/corner_accuracy.png" width="100%">
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1193645_Spain in Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1368349_Spain in Possession.jpg" width="100%">
</td>
</tr>
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1381427_Spain in Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1381503_Spain in Possession.jpg" width="100%">
</td>
</tr>
<tr>
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1193645_Spain out of Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1368349_Spain out of Possession.jpg" width="100%">
</td>
</tr>
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1381427_Spain out of Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/convex_hull/1381503_Spain out of Possession.jpg" width="100%">
</td>
</tr>
</table>
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1193645_In Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1368349_In Possession.jpg" width="100%">
</td>
</tr>
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1381427_In Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1381503_In Possession.jpg" width="100%">
</td>
</tr>
<tr>
<td colspan="2" style="text-align:center; padding:16px 4px 4px;">
...
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1193645_Out of Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1368349_Out of Possession.jpg" width="100%">
</td>
</tr>
<tr>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1381427_Out of Possession.jpg" width="100%">
</td>
<td style="width:50%; padding:4px;">
<img src="results/plots/defenders/1381503_Out of Possession.jpg" width="100%">
</td>
</tr>
</table>
